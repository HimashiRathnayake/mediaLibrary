...
export const TabNavigator = ({type}) => (
    <Tabs.Navigator tabBarOptions={{tabStyle:{paddingTop: 20}, style:{backgroundColor:'transparent', borderTopWidth:0, left:0, right:0, bottom:0, height: 70,position:'absolute'}}}>
